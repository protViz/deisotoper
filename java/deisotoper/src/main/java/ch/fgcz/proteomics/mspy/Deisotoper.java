...
public class Deisotoper {
    public static MassSpecMeasure deisotopeMSM(MassSpecMeasure input) {
        ...
        //
        // List<Peak> outputpeaklist =
        // Mspy.deconvolute(Mspy.deisotope(inputpeaklist.getPeaklist(), 3, 0.05, 0.5,
        // 0.0),
        // 0);
        //
        ...
        // }
        //
        // output.addMS(ms.getTyp(), ms.getSearchEngine(), mzlist, intensitylist,
        // ms.getPeptideMass(), ms.getRt(),
