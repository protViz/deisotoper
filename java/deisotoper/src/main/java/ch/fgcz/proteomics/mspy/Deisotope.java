...
public class Deisotope {
    ...
    public static void main(String[] args) {
        List<Double> mza = Arrays.asList(110.0715485, 110.1648788, 112.0395432, 113.0712204, 114.0746384, 115.05056, 115.9784622, 120.080986, 120.0833893, 121.0843735, 125.7498245, 129.0659332,
        ...
        List<Double> ia = Arrays.asList(6250.6640625, 563.5891113281, 787.7743530273, 42913.109375, 927.4467773438, 2023.1707763672, 529.0408325195, 25228.6796875, 1165.1545410156, 603.5643310547,
        ...
        Peaklist plist = new Peaklist(mza, ia);

        List<Peak> pres = deisotope(plist.getPeaklist(), 2, 0.15, 0.5, 0.0);
