...
public class ScoreTest {
     ...
     * 
     * diff2: |123 - (125.86 + 1.008) / 2| = 59.566 and |125.86 - (123 + 1.008) / 2|
     * = 63.856
     * 
     * diff3: |123 - (125.86 + 2 * 1.008) / 3| = 80.3747 and |125.86 - (123 + 2 *
     * 1.008) / 3| = 84.188
     * 
     * diff4: |123 - (2 * 125.86 + 1.008) / 3| = 38.7573 and |125.86 - (2 * 123 +
     * 1.008) / 3| = 43.524
     * 
