...
public class TestMspy {
    ...
    public void setUp() {
        ...
        // List<Double> mzi = Arrays.asList(120.08112, 127.05046, 129.10248, 130.08647,
        // 145.06100, 147.11298, 173.05595,
        // 183.14944, 187.10793, 191.11806, 211.14433, 219.11301, 219.14932, 226.11879,
        // 228.17076, 233.12860,
        // 245.12456, 246.18129, 272.12418, 273.15988, 311.17133, 311.67285, 318.18118,
        // 361.21945, 365.21802,
        // 367.71344, 368.21527, 374.20749, 389.25476, 393.24963, 417.24994, 464.28693,
        // 465.29050, 473.27631,
        // 474.28079, 478.30136, 488.28372, 489.28659, 491.28381, 506.27274, 524.28314,
        // 525.28650, 526.28674,
        // 563.29309, 563.35559, 564.35809, 581.30481, 582.30756, 621.33667, 622.33978,
        // 631.33752, 636.37140);
        // List<Double> ii = Arrays.asList(134798.0, 250757.0, 113242.0, 96282.8,
        // 73135.9, 209426.0, 76674.6, 90304.0,
        // 89916.3, 61007.0, 55596.0, 128882.0, 54083.8, 33974.4, 21921.7, 59215.3,
        // 21259.0, 158157.0, 23047.4,
        // 33589.2, 108160.0, 39693.8, 84191.1, 52743.0, 13328.6, 40664.2, 21989.6,
        // 34377.6, 14409.4, 83177.9,
        // 7503.34, 181362.0, 33635.4, 2454.38, 1675.37, 2984.05, 2407.48, 2389.05,
        // 1778.45, 2974.41, 40190.6,
        // 12985.8, 1740.92, 2295.79, 60876.1, 15365.0, 31691.5, 11432.0, 16625.5,
        // 4982.01, 1941.02, 2423.14);
        // peaklistin = new Peaklist(mzi, ii);
        //
        // // HeLa filtered pd21 ID 10 mMass output
        // List<Double> mzo1 = Arrays.asList(120.08112, 127.05046, 129.10248, 130.08647,
        // 145.06100, 147.11298, 173.05595,
        // 183.14944, 187.10793, 191.11806, 211.14433, 219.11301, 219.14932, 226.11879,
        // 228.17076, 233.12860,
        // 245.12456, 246.18129, 272.12418, 273.15988, 311.17133, 311.67285, 318.18118,
        ...
        // 563.29309, 563.35559, 564.35809, 581.30481, 582.30756, 621.33667, 622.33978,
        // 631.33752, 636.37140);
        // List<Double> io1 = Arrays.asList(134798.0, 250757.0, 113242.0, 96282.8,
        // 73135.9, 209426.0, 76674.6, 90304.0,
        // 89916.3, 61007.0, 55596.0, 128882.0, 54083.8, 33974.4, 21921.7, 59215.3,
        // 21259.0, 158157.0, 23047.4,
        // 33589.2, 108160.0, 39693.8, 84191.1, 52743.0, 13328.6, 40664.2, 21989.6,
    ...
    public void testDeconvolute() {
        // List<Peak> deisotoped = Mspy.deisotope(peaklistin2.getPeaklist(), 3, 0.05,
        // 0.5, 0.0);
        //
        ...
        // }
        //
        // assertPeaklistEquals(deconvoluted, peaklistout2d.getPeaklist()); // ROUNDING
        // PROBOLEMS!
    }

    // private void assertPeaklistEquals(List<Peak> list, List<Peak> list2) {
    // for (int i = 0; i < list.size() || i < list2.size(); i++) {
    // assertEquals("Mz-values should be same! " + list.get(i).getMz() + " - " +
    // list2.get(i).getMz(),
    // list.get(i).getMz(), list2.get(i).getMz(), 0.001);
    // assertEquals("Intensity-values should be same! " + list.get(i).getIntensity()
    // + " - "
    // + list2.get(i).getIntensity(), list.get(i).getIntensity(),
    // list2.get(i).getIntensity(), 0);
    // assertEquals(
    // "Isotope-values should be same! " + list.get(i).getIsotope() + " - " +
    // list2.get(i).getIsotope(),
    // list.get(i).getIsotope(), list2.get(i).getIsotope(), 0);
    // assertEquals("Charge-values should be same! " + list.get(i).getCharge() + " -
    // " + list2.get(i).getCharge(),
