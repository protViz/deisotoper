...
public class ScoreTest {
     ...
     * 
     * With given x(123.0, 550.42) and y(125.86, 467.55) peaks, it is possible to precalculate the results.
     * 
     * So now we precalculate the diff functions:
     * 
     * diff1: |123 - 125.86| = 2.86
     * 
     * diff2: |123 - (125.86 + 1.008) / 2| = 59.566 and |125.86 - (123 + 1.008) / 2| = 63.856
     * 
     * diff3: |123 - (125.86 + 2 * 1.008) / 3| = 80.3747 and |125.86 - (123 + 2 * 1.008) / 3| = 84.188
     * 
     * diff4: |123 - (2 * 125.86 + 1.008) / 3| = 38.7573 and |125.86 - (2 * 123 + 1.008) / 3| = 43.524
     * 
     * In the standart configurated amino acid masses (from charge 1 to 3) there would be matches (with error tolerance of 0.3) at 131.04049 (charge 3, matches with diff4(y, x)), 128.09496 (charge 2,
     * matches with diff2(y, x)) and 128.05858 (charge 2 matches with diff2(y, x)).
     */
    @Test
    public void testF1() {
        ...
        double score1 = s.firstNonintensityFeature(x, y, e, config);
     ...
     * 
     * With given x(123.0, 550.42) and y(141.0, 467.55) peaks, it is possible to precalculate the results.
     * 
     * The NH3 mass is 17.03052 and the H2O mass is 18.01528. Therefore the value of diff1, diff2, diff3 and diff4 must be in the range calculated from NH3 and H2O.
     * 
     ...
     * 
     * With given x(123.0, 550.42) and y(138.0, 467.55) peaks, it is possible to precalculate the results.
     * 
     * This function is nearly the same as in the thirdNonintensityFeature function.
     * 
     * The NH mass is 15.01464 and the CO mass is 28.0101. Therefore the value of diff1, diff2, diff3 and diff4 must be in the range calculated from NH and CO.
     * 
     ...
     * 
     * A file is generated with a test value in it and then this file is used to initialize the ScoreConfig object. After all the file is deleted.
     */
    @Test
    ...
    /**
     * Tests diff1, diff2, diff3 and diff4. Results can be calculated by hand and matched with the results.
     * 
     * With given x(120.0, 550.42) and y(150.0, 467.55) peaks, you can calculate what the different diff functions do.
     * 
     * diff1: 120 - 150 = 30
     * 
    ...
    public void testDiff() {
        ...
        double d2 = s.diff2(x, y, config);
        double d3 = s.diff3(x, y, config);
        double d4 = s.diff4(x, y, config);
    ...
    /**
     * Tests sum1, sum2, sum3 and sum4. Results can be calculated by hand and matched with the results.
     * 
     * With given x(120.0, 550.42) and y(150.0, 467.55) peaks, you can calculate what the different sum functions do.
     * 
     * sum1: 120 + 150 = 270
     * 
    ...
    public void testSum() {
        ...
        double s2 = s.sum2(x, y, config);
        double s3 = s.sum3(x, y, config);
        double s4 = s.sum4(x, y, config);
