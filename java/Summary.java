...
public class Summary {
    public static String makeSummary(List<MassSpectrometryMeasurement.MassSpectrum> list) {
        ...
        for (MassSpectrometryMeasurement.MassSpectrum spectrum : list) {
            ...
            summary.append(spectrumID).append(",sum_intensity,").append(intensitysum).append(System.getProperty("line.separator"));
            ...
            summary.append(spectrumID).append(",rt_in_seconds,").append(spectrum.getRt()).append(System.getProperty("line.separator"));
            spectrumID++;
        }
