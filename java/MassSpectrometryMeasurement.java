...
public class MassSpectrometryMeasurement {
	 ...
	 */
	public static List<MassSpectrum> addMSM(String typ, String searchengine, double[] mz, double[] intensity,
			double peptidmass, double rt, int chargestate, int id, String scans, String title) {
	...
	public static void main(String[] args) {
		...
		for (MassSpectrum element : MSMlist) {
			System.out.print(element.typ + " " + element.searchengine + " " + element.rt + " " + element.peptidmass
					+ " " + element.chargestate);
			System.out.println();
		}

		System.out.println(GsonMSM.serializeMSMToJson("./src/main/data/test.json", getMSMlist()));

		List<MassSpectrometryMeasurement.MassSpectrum> list = GsonMSM
				.deserializeJsonToMSM("/srv/lucas1/eclipse-workspace/deisotoper/src/main/data/test.json");
