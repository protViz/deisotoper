...
public class MassSpectrometryMeasurement {
    ...
    public static List<MassSpectrometryMeasurement> addMSM(String typ, String searchengine, double[] mz, double[] intensity, double peptidmass, double rt, int chargestate) {
        MassSpectrometryMeasurement MSM = new MassSpectrometryMeasurement();

        MSM.setTyp(typ);
        MSM.setSearchEngine(searchengine);
        MSM.setMz(mz);
        MSM.setIntensity(intensity);
        MSM.setPeptidMass(peptidmass);
        MSM.setRt(rt);
        MSM.setChargeState(chargestate);
    ...
    public static void main(String[] args) {
        ...
        for (MassSpectrometryMeasurement element : MSMlist) {
