...
vignette: >
  %\VignetteIndexEntry{Comparation Of Test Data}
...
input <- c(load(system.file("extdata", name = 'Mix1a_1_DDA_FIRST100MS.RData', package = "deisotoper")), load(system.file("extdata", name = 'Mix1a_1_DDA_PD_DECONVOLUTED_FIRST100MS.RData', package = "deisotoper")))
