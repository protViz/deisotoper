...
\item founded 2002
\item task of FGCZ
\item structure 40 staff members, 6 computer scientists, 10 bioinformatitions
\end{itemize}


\chapter{Environment}
The Eviroment includes 20 mass spectrometry devices and 5 DNA sequencer. There are more than 1000 active nodes of Microsoft Windows, Linux and Mac OSX. The data management system is called b-fabric and there is about 500TB of storage. For my project I used a development environment on Linux using Java 8.
...
\chapter{My Projetct Tasks}

Implementation of deisotoper .... see next chapter
%\section{Practical semester}
...
\part{Deisotoping}
\chapter{Problem Definition} %Definition of Deisotoping}

\section{Chemical view - What is an isotope pattern?}

\section{Modeling isotopic pattern}

\section{Deconvoluting isotopic pattern}
...
Available Deisotoping software
...
\chapter{Evaluation}
\section{Datasets for comparison / Sample data}
hela...
