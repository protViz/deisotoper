...
for(i in 1:length(MS$getMzArray())) {
  print(paste(MS$getMzArray()[[i]], "-" ,MS$getIntensityArray()[[i]]))
}
for(i in 1:length(MSd$getMzArray())) {
  print(paste(MSd$getMzArray()[[i]], "-" ,MSd$getIntensityArray()[[i]]))
}

print(MSd$getChargeArray())
